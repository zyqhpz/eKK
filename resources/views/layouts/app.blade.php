<x-layouts.base>
    ...
    @if(in_array(request()->route()->getName(), ['dashboard', 'profile', 'profile-example', 'profile-club', 'paperwork-club', 'paperwork-club-status', 'paperwork-club-list', 'paperwork-status', 'pdf-generator', 'users', 'bootstrap-tables', 'transactions',
    'buttons',
