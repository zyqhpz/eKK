    ...
    <div class="row">
        <div class="col-12 col-xl-8">
            <div class="card card-body border-0 shadow mb-4">
                <h2 class="h5 mb-4">Maklumat Kelab</h2>
                <form action="#" autocomplete="off">
                    <div class="row">
                        ...
                        <div class="mb-3">
                            <label for="club-name">Name Kelab</label>
                            <input class="form-control" id="club-name" type="text"
                                placeholder="Masukkan nama kelab" value="Badan Dakwah dan Rohani UTeM" required disabled>
                        </div>
                    </div>
                    <div class="row align-items-center">
                        <div class="col-md-6 mb-3">
                            <label for="birthday">Tarikh Penubuhan Kelab</label>
                            <div class="input-group">
                                ...
                                <input data-datepicker=""
                                    ...
                                    placeholder="yyyy/mm/dd" value="10/10/2004" disabled>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label for="official-email">Email Rasmi Kelab</label>
                                <input  class="form-control" id="official-email" type="email"
                                    placeholder="name@company.com" value="badar.utem@gmail.com" disabled>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="registered-club">Kelab Berdaftar</label>
                            <select class="form-select mb-0" id="registered-club" disabled
                                aria-label="Gender select example">
                                <option>Gender</option>
                                <option value="0" selected>HEPA</option>
                                <option value="1">Fakulti</option>
