                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            ...
                            <p class="mb-0"> 
                                <p class="mb-0">Log masuk menggunakan butiran berikut:</p>
                                <div class="my-2">
                                    Admin
                                ...
                                <div class="my-2">
                                    Kelab
                                    <p class="mb-0"> Email: <strong>kelab.a@volt.com</strong> Password:
                                        <strong>secret</strong></p>
                                </div>
                                <div class="my-2">
                                    Penasihat Kelab
                                    <p class="mb-0"> Email: <strong>penasihat.a@volt.com</strong> Password:
                                        <strong>secret</strong></p>
                                </div>
                                <div class="my-2">
                                    Pegawai HEPA
                                    <p class="mb-0"> Email: <strong>hepa.a@volt.com</strong> Password:
                                        <strong>secret</strong></p>
                                </div>
                                <div class="my-2">
                                    TNC (HEPA)
                                    <p class="mb-0"> Email: <strong>tnc.hepa@volt.com</strong> Password:
                                        <strong>secret</strong></p>
                                </div>
                                <div class="my-2">
                                    NC
                                    <p class="mb-0"> Email: <strong>nc@volt.com</strong> Password:
                                        <strong>secret</strong></p>
                                </div>
                            </p>
                        </div>
